...
<html lang="en">
   <head>
      ...
      <c:url value="/resources" var="urlPublic"></c:url>
      <c:url value="/" var="urlRoot"></c:url>
   ...
   <body>
      ...
      <div class="container theme-showcase" role="main">
         ...
         ${instancia}
         <form:form class="form-horizontal" method="post" modelAttribute="instancia" action="${urlRoot}contacto">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <form:select id="genero" path="genero" multiple="multiple" class="form-control" items="${generos}"/>               
               </div>
            </div>
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <label><form:checkboxes items="${notificaciones}" path="notificaciones"/>
               </div>
            </div>
